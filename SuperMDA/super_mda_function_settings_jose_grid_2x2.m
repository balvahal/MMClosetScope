...
%
[grid] = super_mda_grid_maker(smdaPilot.mm,'upper_left_corner',smdaPilot.itinerary.group(i).position(j).xyz(t,:),'number_of_columns',3,'number_of_rows',3,'overlap',300);
%% Set PFS
%
