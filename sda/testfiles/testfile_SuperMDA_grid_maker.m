...
grid28 = SuperMDA_grid_maker(mmhandle,'number_of_columns',3,'number_of_rows',5,'centroid',[0,0,0],'overlap_x',-500,'overlap_y',-200,'overlap_units','px');
grid26 = SuperMDA_grid_maker(mmhandle,'number_of_columns',3,'number_of_rows',5,'upper_left_corner',[0,0,0],'overlap_x',-500,'overlap_y',-200,'overlap_units','px');
grid25 = SuperMDA_grid_maker(mmhandle,'number_of_columns',3,'number_of_rows',5,'lower_right_corner',[0,0,0],'overlap_x',-500,'overlap_y',-200,'overlap_units','px');
grid3 = SuperMDA_grid_maker(mmhandle,'upper_left_corner',[0,0,0],'lower_right_corner',[1000,3000,0]);
grid68 = SuperMDA_grid_maker(mmhandle,'diameter',3000,'overlap',50,'centroid',[-2000,-2000,0],'overlap_units','px');
myfig = figure;
